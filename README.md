...
| --- | --- | --- |
| [msmarco-genqa](https://github.com/GioiaZheng/msmarco-genqa) | RAG on MS MARCO with retrieval, reranking, generation, and statistical evaluation | Research-engineering flagship: reproducible baselines, paired comparisons, grounding analysis, CI, and written experiment reports |
