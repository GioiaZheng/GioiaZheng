...
A full-stack chat web application developed for the *Web and Software Architecture* course.  
Focuses on API design, containerization, and client-server communication.  
(Currently private until final evaluation)
